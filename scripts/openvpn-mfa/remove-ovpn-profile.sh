...
docker exec -it openvpn-mfa bash -c "deluser --remove-home $1"
...
### Remove a ccd file
echo "removed -> /opt/openvpn-mfa-ccd/$1"
rm -f /opt/openvpn-mfa-ccd/$1
...
### Remove .ovpn file
echo "removed -> /opt/openvpn-mfa-profiles/$1.ovpn"
rm -f /opt/openvpn-mfa-profiles/$1.ovpn
